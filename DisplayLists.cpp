...
void Game::compileDisplayLists(){
	...
	glBegin(GL_QUADS);
		glTexCoord2f(0.75f,0.f); 		glVertex3f(1.f,1.f,0.f);
		glTexCoord2f(1.0f,0.f); 		glVertex3f(0.f,1.f,0.f);
		glTexCoord2f(1.0f,0.25f); 		glVertex3f(0.f,0.f,0.f);
		...
		glTexCoord2f(0.75f,0.f); 		glVertex3f(0.f,1.f,1.f);
		glTexCoord2f(1.0,0.f); 			glVertex3f(1.f,1.f,1.f);
		glTexCoord2f(1.0,0.25f); 		glVertex3f(1.f,0.f,1.f);
		glTexCoord2f(0.75f,0.25f); 		glVertex3f(0.f,0.f,1.f);
	glEnd();
	glEndList();
}
